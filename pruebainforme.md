...
## Introduccion
	...
	En este trabajo buscamos transmitir info sobre Phyton. Hablar sobre 
	como funciona , como instalarlo en tu computadora,su sintaxis basica
	(operaciones,condiciones y bucles) tambien veremos como crear clases.
...
### Phyton
	...
	código fuente para las principales plataformas desde el sitio web de Python,[http://www.python.org/] (http://www.python.org/), y
